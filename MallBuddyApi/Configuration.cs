namespace MallBuddyApi.Migrations
{
    ...
    using MallBuddyApi.Models.existing;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MallBuddyApi.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(MallBuddyApi.Models.ApplicationDbContext context)
        {
            ...
            if (poi.Type!=null)
            {
                switch (poi.Type)
                {
                    case POI.POIType.STORE:
                        {
                            poi = new Store {Type = poi.Type, Anchor = labeledPoint, Enabled = true
                            ,                        Floor = level,
